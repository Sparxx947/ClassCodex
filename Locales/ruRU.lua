...
L["about.supporters"] = "Благодарности"
L["about.free_message"] = "Class Codex бесплатен и открыт для всех. Он продолжает аддон, изначально написанный jfstn, и поддерживается на github.com/Sparxx947/ClassCodex."
L["credits.role.original"] = "Первоначальный автор"
L["credits.role.continuation"] = "Продолжение и обновление данных"
L["credits.role.tlm"] = "TalentLoadoutManager (MIT)"
L["credits.role.libs"] = "Встроенные библиотеки"
L["credits.role.data"] = "Данные гайдов"
