...
L["about.supporters"] = "크레딧"
L["about.free_message"] = "Class Codex는 모두에게 무료로 공개되어 있습니다. jfstn이 처음 만든 애드온을 이어받아 github.com/Sparxx947/ClassCodex에서 관리되고 있습니다."
L["credits.role.original"] = "원 제작자"
L["credits.role.continuation"] = "계승 및 데이터 관리"
L["credits.role.tlm"] = "TalentLoadoutManager (MIT)"
L["credits.role.libs"] = "포함된 라이브러리"
L["credits.role.data"] = "공략 데이터"
